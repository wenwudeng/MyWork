    ...
    public ReviewRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //传参
                JsonUtil.bean = new CardViewItemBean(item.getUserId(),item.getArticleId(), item.getArtTitle(), item.getImg(), item.getArticleContent(), item.getAuthorName(), item.getAuthorPhoto(), item.getaLike());
