 ...
 */
public class NewFansAdapter extends RecyclerView.Adapter<NewFansAdapter.ViewHolder> {
    private List<MsgAddNewConcern> list;
    private NewFansActivity activity;
    ...
    public NewFansAdapter(List<MsgAddNewConcern> list, NewFansActivity activity) {
        this.list = list;
    ...
    @NonNull
    @Override
    public NewFansAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_fans_item, parent, false);
        final NewFansAdapter.ViewHolder holder = new NewFansAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull NewFansAdapter.ViewHolder holder, int position) {
        MsgAddNewConcern fans = list.get(position);
    ...
    /*查询粉丝状态*/
    public  void isFans(int id, NewFansAdapter.ViewHolder holder) {
