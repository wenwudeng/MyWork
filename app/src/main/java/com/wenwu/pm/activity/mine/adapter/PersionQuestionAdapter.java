 ...
 */
public class PersionQuestionAdapter extends RecyclerView.Adapter<PersionQuestionAdapter.ViewHolder>{
    private List<QuestionCardViewItem> questionCardViewItemList;
    private QuestionCardViewItem item;


    public PersionQuestionAdapter(List<QuestionCardViewItem> cardViewItemBeanList) {
    ...
    @NonNull
    @Override
    public PersionQuestionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final PersionQuestionAdapter.ViewHolder holder = new PersionQuestionAdapter.ViewHolder(view);
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull PersionQuestionAdapter.ViewHolder holder, int position) {
