...
public class ArticleShowActivity extends AppCompatActivity {
    ...
    private void initData() {
        String content = "写得很详细，受教了。没有变动，乖乖呆在家里的就不用说明了,再次强调下，疫情结束前暂停所有实习任务，请务必听从学校的安排，安全第一。";
        String content1 = "热爱生命，就是热爱自己，热爱他人。";
            ArticleReview review1 = new ArticleReview(R.drawable.li, "留白", "一周前", 0, content);
            reviewList.add(review1);
            ArticleReview review2 = new ArticleReview(R.drawable.li, "留白", "一周前", 0, content1);
